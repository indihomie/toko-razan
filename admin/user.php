...
<?php 
	...
	if(isset($_POST['adduser']))
	{
		...
		$tambahuser = mysqli_query($conn,"insert into login (userid, namalengkap, email, password, notelp, role) values('','$namastaff','$username','$password','$notelp','Admin')");
		if ($tambahuser){
...
<head>
    ...
    <title>Kelola Staff - TokoRazan</title>
						...
						<div class="modal-body">
							<form method="post">
                                <div class="form-group">
									...
									<input name="namastaff" type="text" class="form-control" placeholder="Nama Staff" required autofocus>
								</div>
                                <div class="form-group">
									<label>Nomor Telepon</label>
									<input name="notelp" type="number" class="form-control" placeholder="Nomor Telepon" required autofocus>
								</div>
								<div class="form-group">
